...
erDiagram
    ...
    NOTIFICATIONS_INFO ||--o{ PATIENTS_DISEASES : "connected by notification_id"
    NOTIFICATIONS_INFO ||--o{ CLINICAL_SIGNS : "connected by notification_id"
    NOTIFICATIONS_INFO ||--o{ PERSONAL_DATA : "connected by notification_id"
    NOTIFICATIONS_INFO ||--o{ HOSPITAL_INFO : "connected by notification_id"
    NOTIFICATIONS_INFO ||--o{ EXAMS : "connected by notification_id"
